...
fun createScope(input: DataInput, jagr: Jagr, parent: SerializationScope.Input? = null): SerializationScope.Input {
    return InputSerializationScopeImpl(input, jagr, parent)
}

inline fun <T> openScope(input: DataInput, jagr: Jagr, block: SerializationScope.Input.() -> T): T {
