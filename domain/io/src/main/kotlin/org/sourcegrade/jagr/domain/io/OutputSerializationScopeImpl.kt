...
fun createScope(output: DataOutput, jagr: Jagr, parent: SerializationScope.Output? = null): SerializationScope.Output {
    return OutputSerializationScopeImpl(output, jagr, parent)
}

inline fun <T> openScope(output: DataOutput, jagr: Jagr, block: SerializationScope.Output.() -> T): T {
...
private class OutputSerializationScopeImpl(
    override val output: DataOutput,
