...
class JavaSourceLinker(private val sourceFiles: Map<String, JavaSourceFile>) {
    fun link(compiledClass: JavaCompiledClass) {
        ...
        if (visitor.sourceFileName != null) {
            compiledClass.sourceFile = sourceFiles[visitor.sourceFileName]
        }
    }
}

fun Map<String, JavaCompiledClass>.linkSource(sourceFiles: Map<String, JavaSourceFile>) {
