...
class ExtendedStandardJavaFileManager(
    ...
    private val classPath: Map<String, JavaCompiledClass>,
    private val classStorage: MutableMap<String, JavaCompiledClass>,
    ...
    override fun getJavaFileForOutput(
        ...
        try {
            val compiledClass = JavaCompiledClass.Runtime(className)
    ...
    override fun inferBinaryName(location: JavaFileManager.Location, file: JavaFileObject): String {
        if (file is JavaCompiledClass.Existing) {
