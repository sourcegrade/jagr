...
data class JavaCompiledResourceContainer(
    ...
    val errors: Int = 0,
    val other: Int = 0,
) : CompileResult, RuntimeResourceContainer {
    ...
    companion object Factory : SerializerFactory<JavaCompiledResourceContainer> {
        override fun read(scope: SerializationScope.Input): JavaCompiledResourceContainer = JavaCompiledResourceContainer(
            scope.read(),
            scope.read(),
            scope.readList(),
            scope.input.readInt(),
        ...
        override fun write(obj: JavaCompiledResourceContainer, scope: SerializationScope.Output) {
