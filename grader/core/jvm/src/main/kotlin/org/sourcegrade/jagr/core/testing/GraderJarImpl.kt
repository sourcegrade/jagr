...
import org.sourcegrade.jagr.domain.rubric.RubricForSubmission
import org.sourcegrade.jagr.api.rubric.RubricProvider
import org.sourcegrade.jagr.domain.rubric.TestForSubmission
import org.sourcegrade.jagr.agent.compiler.graderInfo
...
class GraderJarImpl(
    ...
    private fun MutableMap<String, MutableList<String>>.putIfRubric(clazz: Class<*>) {
        val filter = clazz.getAnnotation(org.sourcegrade.jagr.domain.rubric.RubricForSubmission::class.java) ?: return
    ...
    private fun MutableMap<String, MutableList<String>>.putIfTest(clazz: Class<*>) {
        val filter = clazz.getAnnotation(org.sourcegrade.jagr.domain.rubric.TestForSubmission::class.java) ?: return
